...
class ProcurementOrderLineExportMapper(ExportMapper):
    ...
    direct = [
        (m2o_to_backend('medical_prescription_order_line',
        ...
        (follow_m2o_relations('medical_prescription_order_line.'
                              'medication_dosage_id.name'),
         'sig_text'),
        (follow_m2o_relations('medical_prescription_order_line.quantity'),
         'units_per_dose'),
        (follow_m2o_relations('medical_prescription_order_line.frequency'),
         'freq_of_admin'),
