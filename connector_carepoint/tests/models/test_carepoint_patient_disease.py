...
class CarepointPatientDiseaseTestBase(SetUpCarepointBase):

    def setUp(self):
        super(CarepointPatientDiseaseTestBase, self).setUp()
        self.model = 'carepoint.carepoint.patient.disease'
...
class TestCarepointPatientDiseaseImportMapper(
    CarepointPatientDiseaseTestBase
):

    def setUp(self):
        super(TestCarepointPatientDiseaseImportMapper, self).setUp()
        self.Unit = \
            medical_patient_disease.CarepointPatientDiseaseImportMapper
...
class TestCarepointPatientDiseaseUnit(CarepointPatientDiseaseTestBase):

    def setUp(self):
        super(TestCarepointPatientDiseaseUnit, self).setUp()
        self.Unit = medical_patient_disease.CarepointPatientDiseaseUnit
        self.unit = self.Unit(self.mock_env)
    ...
    def test_import_by_patient_unit_for_adapter(self):
        ...
        with mock.patch.object(self.unit, 'unit_for') as mk:
            ...
            mk.assert_has_calls([
                mock.call(
                    medical_patient_disease.CarepointPatientDiseaseAdapter,
                ),
                mock.call(
                    medical_patient_disease.CarepointPatientDiseaseImporter,
                ),
            ])
...
class TestCarepointPatientDiseaseImporter(CarepointPatientDiseaseTestBase):

    def setUp(self):
        super(TestCarepointPatientDiseaseImporter, self).setUp()
        self.Unit = medical_patient_disease.CarepointPatientDiseaseImporter
        self.unit = self.Unit(self.mock_env)
        ...
        with mock.patch.object(self.unit, '_import_dependency'):
            with mock.patch.object(self.unit, 'unit_for'):
                ...
                self.unit.unit_for.assert_has_calls([
                    mock.call(
                        medical_patient_disease.CarepointPathologyUnit,
...
class TestCarepointPatientDiseaseExporter(CarepointPatientDiseaseTestBase):

    def setUp(self):
        super(TestCarepointPatientDiseaseExporter, self).setUp()
        self.Unit = medical_patient_disease.CarepointPatientDiseaseExporter
        self.unit = self.Unit(self.mock_env)
        self.unit.carepoint_record = self.record
